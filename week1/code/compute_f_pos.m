...
% CALCULATIONS
% h1 = H1 * f/(d1_ref-pos) != H1 * f_ref / d1_ref
% h2 = H2 * f/(d2_ref-pos) != h1/ratio
% 
% -> two equations with two unkowns (pos, f)
%
% YOUR CODE HERE


fprintf('Working on compute_f_pos');
fprintf('\n');
